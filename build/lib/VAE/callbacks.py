...
class ModelCheckpoint(callbacks.ModelCheckpoint):
    ...
    Parameters:
        ...
        **kwargs :
            Additional keyword arguments to be passed to `callbacks.ModelCheckpoint`.
    """
    def __init__(self, filepath, period=1, **kwargs):
...
class Evaluate(callbacks.Callback):
    ...
    the parameters see the Keras documentation for :func:`keras.Model.evaluate`.
    ...
    Parameters:
        ...
        **kwargs :
            Additional keyword arguments to be passed to `callbacks.Callback`.

    raises:
        ValueError: If the prefix is empty or `val_`.

    """
    def __init__(self, x=None, y=None, batch_size=None, verbose=0, sample_weight=None, prefix='val2_', **kwargs):
        self.x = x
        self.y = y
