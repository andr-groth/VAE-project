...
class LearningRateFinder:
    ...
    def find_generator(self,
        ...
        callback = ks.callbacks.LambdaCallback(
...
if __name__ == '__main__':
    ...
    lr_schedule = ExponentialDecay(initial_learning_rate=0.001, decay_steps=10, decay_rate=0.5,
                                   warmup_steps=10, staircase=False)
